...
public class ClassInserter {
	...
	public static int insert(String oldFileDir, String newFileDir, String userName) {
		...
		while(classRepo.findByVersionID(versionID)!=null&&classRepo.findByVersionID(versionID).size()>0) {
			versionID = random.nextInt(Integer.MAX_VALUE);
		}
